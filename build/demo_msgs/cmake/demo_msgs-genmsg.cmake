...
message(STATUS "demo_msgs: 1 messages, 0 services")

set(MSG_I_FLAGS "-Idemo_msgs:/home/tom/catkin_ws/src/demo_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tom/catkin_ws/src/demo_msgs/msg/carry.msg" NAME_WE)
add_custom_target(_demo_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "demo_msgs" "/home/tom/catkin_ws/src/demo_msgs/msg/carry.msg" ""
)
...
_generate_msg_cpp(demo_msgs
  "/home/tom/catkin_ws/src/demo_msgs/msg/carry.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/demo_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/demo_msgs\")")
  # install generated code
  install(
